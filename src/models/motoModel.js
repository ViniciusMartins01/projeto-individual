...
function listar() {
    ...
    var instrucaoSql = `
            select modelo, velocidadeMax, peso, potencia, consumo, torque, preco, cilindrada, imagem, nome as categoria from moto join categoria on fkCategoria = idCategoria;
        `;
